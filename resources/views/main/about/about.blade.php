        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 col-md-12">
                <ul class="header-top-menu">
                    <li>
                        <a href="../login.blade.php"><i class="bx bxs-user"></i> My Account</a>
                    </li>
                    <li>
                        <a
                            href="#"
                    ...
                    <li>
                        <a href="../login.blade.php"><i class="bx bx-log-in"></i> Login</a>
                    </li>
                </ul>
        ...
        <div class="container">
            <div class="xton-responsive-menu">
                <div class="logo">
                    <a href="index.html">
                        <img
                            src="assets/img/tessablack3.png"
                            class="main-logo"
                            alt="logo"
                        />
                        <img
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
                <div class="about-image">
                    <img
                        src="assets/img/about/about-photo-1-01.png"
                        class="shadow"
                        alt="image"
                    />
                    <img
                        src="assets/img/about/about-photo-2-01.png"
                        class="shadow"
                        alt="image"
                    />
                </div>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="about-content">
                    ...
                    <h6>
                        Xton.com offers you flexible and responsive shopping experience.
                    </h6>
                    <p>
                    ...
                    <div class="features-text">
                        <h5>
                            <i class="bx bx-planet"></i>Ships to more than 10 countries
                            and regions
                        </h5>
                        <p>
    ...
    <div class="container">
        ...
        <div class="partner-slides owl-carousel owl-theme">
            <div class="partner-item">
                <a href="#"
                ><img src="assets/img/partner/partner1.jpg" alt="image"
                    /></a>
            </div>

            <div class="partner-item">
                <a href="#"
                ><img src="assets/img/partner/partner2.jpg" alt="image"
                    /></a>
            </div>

            <div class="partner-item">
                <a href="#"
                ><img src="assets/img/partner/partner3.jpg" alt="image"
                    /></a>
            </div>

            <div class="partner-item">
                <a href="#"
                ><img src="assets/img/partner/partner4.jpg" alt="image"
                    /></a>
            </div>

            <div class="partner-item">
                <a href="#"
                ><img src="assets/img/partner/partner6.jpg" alt="image"
                    /></a>
            </div>

            <div class="partner-item">
                <a href="#"
                ><img src="assets/img/partner/partner7.jpg" alt="image"
                    /></a>
            </div>
        </div>
    </div>
...
<div class="instagram-area">
    <div class="container-fluid">
        <div class="instagram-title">
            <a
                href="https://www.instagram.com/tessabeauty.institute/"
                target="_blank"
            ><i class="bx bxl-instagram"></i> Follow us on @tessa</a
            >
        </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-footer-widget">
                    ...
                    <ul class="customer-support">
                        <li><a href="../login.blade.php">My Account</a></li>
